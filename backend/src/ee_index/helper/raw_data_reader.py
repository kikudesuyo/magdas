import numpy as np
from src.ee_index.constant.raw_data import (
    EIGHT_COMPONENTS,
    FOUR_COMPONENTS,
    SEVEN_COMPONENTS,
)
...
def read_raw_min_data(absolute_path):
    """
    .mag形式の読み込み

    Arg:
      absolute_path (str): .mag形式の絶対パス
    Return:
...
def read_raw_sec_data(absolute_path):
    """
    .mgdファイルの読み込み

    Arg:
      absolute_path (str): .mgdファイルの絶対パス
    Return:
